...
PLAYERS = (
    ...
    ("1075", "Tiare Jennings", "TEX", "Active", "hitter", ("ausl_veteran", "single_school", "hitter", "award_or_record", "wcws_or_championship"), "Oklahoma career record holder and four-time champion with an official AUSL-season profile."),
...
SOURCE_SPECS = {
    ...
    "ou-jennings-ausl": ("official_school_athletics", "University of Oklahoma Athletics", "Sooner Alumnae Start 2026 AUSL Season", "https://soonersports.com/news/2026/6/9/softball-sooner-alumnae-start-2026-ausl-season", "Tiare Jennings (Texas Volts) section", "2026"),
...
PROGRAMS = {
    ...
    "1075": (("oklahoma", "Oklahoma", 1, 2021, 2024, "ou-jennings-ausl", ()),),
...
RECORDS = {
    ...
    "1075": (("source_career_batting", "hitter", "oklahoma", None, "ou-jennings-ausl", {"hits": 314, "home_runs": 98, "rbi": 314, "runs": 277, "batting_average": "0.412"}),),
...
ACHIEVEMENTS = {
    ...
    "1075": ("championship", "Four-time NCAA champion with Oklahoma, 2021-2024", "2024", "oklahoma", "ou-jennings-ausl"),
